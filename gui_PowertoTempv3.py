...
class ExtendedPowerTempApp(tk.Tk):
    ...
    def _build(self):
        ...
        self.txt = tk.Text(right, height=8)
        self.txt.pack(side=tk.BOTTOM, fill=tk.X, pady=(6,0))
    ...
    # show message in GUI text box and also print to console for visibility
        try:
    ...
    def _on_compute(self):
        ...
        # Temperature plot: show only junction temperature (absolute)
        self.ax_temp.clear()
        self.ax_temp.plot(tgrid, T_abs, '-', label='Junction Temperature (°C)')
